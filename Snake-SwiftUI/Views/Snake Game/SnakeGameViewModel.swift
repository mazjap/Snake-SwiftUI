...
//        }
//    }
//    private var currentSnekDirection: Direction = .right
//
...
class SnakeGameViewModel: ObservableObject {
    ...
    func startNewGame(difficulty: Difficulty, snake: Snake? = nil) {
        ...
        let startValue = Int(difficulty.rawValue / 2)
        let initialSnake = snake ?? Snake(head: Position(x: startValue, y: startValue), body: [Position(x: startValue, y: startValue - 1)], direction: .defaultStartDirection)
